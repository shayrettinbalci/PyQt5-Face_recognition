...
class face_lib(object):
    ...
    def set_photo(self, video_base, photo_base):
        """
        :param video_base: directory that contain videos
        :param photo_base: extracted photos from video will be saved in this directory
        """
        ...
        for label in video_dir:
            for i, fn in enumerate(os.listdir(os.path.join(video_base, label))):
                ...
                while True:
                    ...
                    # stop image extracting when finish video
                    frame_count += 1
    ...
    def set_faces(self, photo_base, face_base, cropper):
        """
        :param photo_base: directory that contain videos
        :param face_base: extracted faces from photos will be saved in this directory
        :param cropper: set face's photos size and zoom factor of faces
        """
    ...
    def delete_temp(self, folder):
        """
        :param folder: delete everything into folder
        """
